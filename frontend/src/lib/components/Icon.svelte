<script lang="ts">
  ...
  const PATHS: Record<string, string> = {
    ...
    undo: '<path d="M2.8 5.8v5h5"/><path d="M17.2 14.4a7.4 7.4 0 0 0-12.4-5.5L2.8 10.8"/>',
    redo: '<path d="M17.2 5.8v5h-5"/><path d="M2.8 14.4a7.4 7.4 0 0 1 12.4-5.5l2 1.9"/>',
    ...
    chevronUp: '<path d="m4.6 12.4 5.4-5.2 5.4 5.2"/>',
    ...
    book: '<path d="M3.4 4.6A1.6 1.6 0 0 1 5 3h3.4a2 2 0 0 1 1.6.8 2 2 0 0 1 1.6-.8H15a1.6 1.6 0 0 1 1.6 1.6v8.9A1.4 1.4 0 0 1 15.2 15h-3.6a1.7 1.7 0 0 0-1.6 1 1.7 1.7 0 0 0-1.6-1H4.8a1.4 1.4 0 0 1-1.4-1.5z"/><path d="M10 4.8v11.4"/>',
    chat: '<path d="M17 11.4a2.4 2.4 0 0 1-2.4 2.4H7l-3.6 2.8v-3A2.4 2.4 0 0 1 3 11.4V5.8a2.4 2.4 0 0 1 2.4-2.4h9.2A2.4 2.4 0 0 1 17 5.8z"/>',
    star: '<path d="m10 3 2.16 4.5 4.84.68-3.5 3.46.83 4.96L10 14.25 5.67 16.6l.83-4.96L3 8.18l4.84-.68z"/>',
    download: '<path d="M10 3.4v8.8"/><path d="m6.4 9 3.6 3.4L13.6 9"/><path d="M3.6 14.2v1.4a1.4 1.4 0 0 0 1.4 1.4h10a1.4 1.4 0 0 0 1.4-1.4v-1.4"/>',
    sort: '<path d="M6 4.2v11.6"/><path d="m3.2 7 2.8-2.8L8.8 7"/><path d="M14 15.8V4.2"/><path d="m11.2 13 2.8 2.8L16.8 13"/>',
    sparkles: '<path d="m7.4 3.4 1.1 2.9 2.9 1.1-2.9 1.1-1.1 2.9-1.1-2.9L3.4 7.4l2.9-1.1z"/><path d="m14 10.4.75 1.95 1.95.75-1.95.75-.75 1.95-.75-1.95-1.95-.75 1.95-.75z"/>',
    trash: '<path d="M3.8 5.6h12.4"/><path d="M8.2 5.6V4.2a1 1 0 0 1 1-1h1.6a1 1 0 0 1 1 1v1.4"/><path d="M5.4 5.6v9.8a1.4 1.4 0 0 0 1.4 1.4h6.4a1.4 1.4 0 0 0 1.4-1.4V5.6"/><path d="M8.4 8.8v5"/><path d="M11.6 8.8v5"/>',
    ...
    note: '<path d="M3.6 5a1.4 1.4 0 0 1 1.4-1.4h10A1.4 1.4 0 0 1 16.4 5v6.2l-4.2 5.2H5a1.4 1.4 0 0 1-1.4-1.4z"/><path d="M16.4 11.2h-2.8a1.4 1.4 0 0 0-1.4 1.4v3.8"/><path d="M6.4 7.4h7.2"/><path d="M6.4 10h4.4"/>',
    ...
    highlighter: '<path d="m10.4 12.6-3 3-2.4-2.4 3-3"/><path d="m7.4 9.6 5-5a1.4 1.4 0 0 1 2 0l1.4 1.4a1.4 1.4 0 0 1 0 2l-5 5z"/><path d="M3.4 17.4h5"/>',
    zoomIn: '<circle cx="9" cy="9" r="5.4"/><path d="m17 17-4.2-4.2"/><path d="M6.8 9h4.4"/><path d="M9 6.8v4.4"/>',
    zoomOut: '<circle cx="9" cy="9" r="5.4"/><path d="m17 17-4.2-4.2"/><path d="M6.8 9h4.4"/>',
