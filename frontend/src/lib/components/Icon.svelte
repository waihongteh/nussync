<script lang="ts">
  ...
  const PATHS: Record<string, string> = {
    ...
    gamepad: '<path d="M6.6 8.4v3.2"/><path d="M5 10h3.2"/><path d="M13.2 9.4h.01"/><path d="M15 11.4h.01"/><path d="M6.6 5.6h6.8a4.6 4.6 0 0 1 4.55 3.93l.5 3.4a2.5 2.5 0 0 1-4.6 1.72l-.8-1.35H8.95l-.8 1.35a2.5 2.5 0 0 1-4.6-1.72l.5-3.4A4.6 4.6 0 0 1 6.6 5.6z"/>',
    trophy: '<path d="M7 3.6h6v4.2a3 3 0 0 1-6 0z"/><path d="M7 5h-2a2 2 0 0 0 2 2.8"/><path d="M13 5h2a2 2 0 0 1-2 2.8"/><path d="M10 10.8v2.6"/><path d="M7.2 16.4h5.6"/><path d="M8.4 13.4h3.2v3h-3.2z"/>',
